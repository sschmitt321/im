 ...
 * @param {*} 参数 
 */
msgApi.getMessageContext = (params) => {
	return postJsonRequest('/enterprise/im/getMessageContext', params)
}
 ...
 * @param {*} 参数 
 */
msgApi.getMessageInfo = (params) => {
	return postJsonRequest('/enterprise/im/getMessageInfo', params)
}
